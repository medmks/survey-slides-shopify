...
${errorInfo.componentStack}`);
  ...
  function Attribution() {
    const [attributionCustomer, setAttributionCustomer] = (0, import_react18.useState)({
      suevryname: "",
      type: "",
      order: "",
      Answers: [
    ...
    const [survey, setSurvey] = (0, import_react18.useState)();
    const [loading, setLoading] = (0, import_react18.useState)(false);
    const updateAnswer = (newAnswer, questionId) => {
      setAttributionCustomer((prevState) => {
        const updatedAnswers = prevState.Answers.map(
          (answer) => answer.id === questionId ? __spreadProps(__spreadValues({}, answer), { Answer: newAnswer }) : answer
        );
    ...
    (0, import_react18.useEffect)(() => {
      ...
      function queryApi() {
        return __async(this, null, function* () {
          ...
          const TheSurvey = yield FetchSurvey(token);
          setSurvey(TheSurvey);
  ...
  function ProductReview() {
    const [productReview, setProductReview] = (0, import_react18.useState)("");
    const [loading, setLoading] = (0, import_react18.useState)(false);
  ...
  function useStorageState(key) {
    ...
    const setStorage = (0, import_react18.useCallback)(
      (value) => {
  ...
  function PreviewSurvey({ survey, updateAnswer, loading, handleSubmit }) {
    ...
    if (submitted) {
      return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(View2, { border: "base", padding: "base", borderRadius: "base", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(BlockStack2, { children: [
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Heading2, { children: "Thanks for your Time \u2728" }),
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Text2, { children: "Your response has been submitted" })
      ] }) });
    }
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(View2, { border: "base", padding: "base", borderRadius: "base", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(BlockStack2, { gap: { xs: "400", md: "200" }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Heading2, { children: survey.title }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Text2, { children: survey.subtitle }),
      survey.typeSurvey !== "Form" && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Text2, { variant: "headingXs", as: "h6", children: "Not Form Rendering" }),
      survey.typeSurvey == "Form" && ((_a = survey.fields) == null ? void 0 : _a.map((field, i) => {
        if (field.type == "date") {
          return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
            DateField,
            {
        ...
        if (field.type == "select") {
          return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(BlockStack2, { children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
            Select2,
            {
              label: field.label,
        ...
        if (field.type == "checkbox") {
          return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(BlockStack2, { children: [
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Text2, { children: field.label }),
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
              ChoiceList2,
              {
                ...
                children: field.options.map((options, o) => {
                  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(BlockStack2, { children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Choice2, { id: options.label, children: options.label }, o) }, o);
                })
              }
            )
          ] }, i);
      ...
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Button2, { kind: "secondary", onPress: HandelPressSubmit, loading, children: "Submit feedback" })
    ] }) });
  }
})();
